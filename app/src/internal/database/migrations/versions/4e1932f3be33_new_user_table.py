...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "role", sa.Column("avatar", sa.VARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "role", sa.Column("role", sa.INTEGER(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "role", sa.Column("password", sa.VARCHAR(), autoincrement=False, nullable=False)
    )
    op.add_column(
        "role", sa.Column("email", sa.VARCHAR(), autoincrement=False, nullable=False)
    )
    op.add_column(
        "role", sa.Column("last_name", sa.VARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        "role",
    ...
    op.add_column(
        "role", sa.Column("username", sa.VARCHAR(), autoincrement=False, nullable=False)
    )
